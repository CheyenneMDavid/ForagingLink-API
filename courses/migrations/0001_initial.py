    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_capacity', models.PositiveIntegerField(default=10, editable=False, help_text='The maximum number of participants for the course.', verbose_name='Maximum Capacity')),
            ],
        ),
    ]
